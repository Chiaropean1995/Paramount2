    ...
    return (
        <>
            <Row className="align-items-center">
                <Col xs={12} md={5} className="px-0 position-relative">
                    ...
                    <div className="border" style={{ height: '300px', marginLeft: "100px" }}>
                        <img src={image_url} className="img-fluid" style={{ height: '100%', width: "100%" }} alt={title} />
                    </div>
                </Col>
                <Col xs={12} md={7} className="px-0">
                    <div className="border p-3" style={{ height: '300px', fontFamily: "Helvetica Neue, Helvetica, Arial,Source Sans Pro, serif", marginRight: "100px" }}>
                        <h5><b>{title}</b></h5>
                        <p style={{ color: "grey" }}>{location}</p>
                        <hr />
                        <p style={{ color: "grey", wordWrap: "break-word", marginBottom: "120px" }}>{description}</p>
                        <hr />
