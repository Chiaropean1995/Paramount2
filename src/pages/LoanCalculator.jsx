                ...
                <div>
                    <div style={{ marginLeft: "200px", marginTop: "100px" }}>
                        <Row>
                            ...
                            <Col sm={12} md={5} className="p-4 border rounded-end p-5 box-shadow" style={{ backgroundColor: "#f0f9fc", boxShadow: "0px 4px 8px rgba(0, 0, 0, 0.1)" }} >
                                <div>
                                    <h5 style={{ fontFamily: "Nunito, Roboto, sans-serif", marginBottom: "10px" }}>Summary:</h5>
                                    <div style={{ marginBottom: "20px" }}>
                                        <div style={{ marginBottom: "200px" }}>
                                            <span style={{ color: "#505050", fontSize: "16px", fontWeight: "bold" }}>Estimated House Budget:</span>
                                            <span style={{ marginLeft: "10px", fontWeight: "bold" }}>{houseBudget ? `RM ${addCommas(houseBudget)}` : "-"}</span>

                                        </div>

                                        <div>
                                            <span style={{ color: "#505050", fontSize: "16px", fontWeight: "bold" }}>Monthly Payment:</span>
